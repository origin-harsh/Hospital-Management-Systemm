...
const links = [
    {name: 'Dashboard', url: '/doctor/dashboard', icon: <IconLayoutDashboardFilled stroke={1.5}/>},
    {name: 'Profile', url: '/doctor/profile', icon: <IconStethoscope  stroke={1.5}/>},
    {name: 'Patients', url: '/doctor/patients', icon: <IconFaceMask  stroke={1.5}/>},
    {name: 'Appointments', url: '/doctor/appointments', icon: <IconCalendarClock  stroke={1.5}/>},
    ...
    <div className='w-64 fixed bg-dark hidden-scroll flex flex-col items-center gap-10 h-screen overflow-y-auto'>
        ...
        <div  className='flex flex-col gap-1 items-center'>
            <div className='p-1 bg-white rounded-full shadow-xl'>
               <Avatar variant='filled' src="/Doctor.png" size='xl' alt="it's me" />
            </div>
