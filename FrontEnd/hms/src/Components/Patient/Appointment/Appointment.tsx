...
import { cancelAppointment, getAppointmentsByPatientId, scheduleAppointment } from '../../../Service/AppointmentService';
    ...
    <div className="card">
      ...
      >
        ...
        <Column
          ...
          body={(rowData) => `Dr. ${rowData.doctorName}`}
        />
         <Column
