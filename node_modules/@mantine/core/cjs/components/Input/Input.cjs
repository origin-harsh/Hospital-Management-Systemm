...
const require_InputClearButton = require("./InputClearButton/InputClearButton.cjs");
const require_InputClearSection = require("./InputClearSection/InputClearSection.cjs");
const require_InputWrapper_context = require("./InputWrapper.context.cjs");
const require_Input_module = require("./Input.module.cjs");
const require_InputDescription = require("./InputDescription/InputDescription.cjs");
...
const varsResolver = require_create_vars_resolver.createVarsResolver((_, props, ctx) => ({ wrapper: {
	"--input-margin-top": ctx.offsetTop ? "calc(var(--mantine-spacing-xs) / 2)" : void 0,
	"--input-margin-bottom": ctx.offsetBottom ? "calc(var(--mantine-spacing-xs) / 2)" : void 0,
	"--input-height": require_get_size.getSize(props.size, "input-height"),
	"--input-fz": require_get_size.getFontSize(props.size),
	"--input-radius": props.radius === void 0 ? void 0 : require_get_size.getRadius(props.radius),
	"--input-left-section-width": props.leftSectionWidth !== void 0 ? require_rem.rem(props.leftSectionWidth) : void 0,
	"--input-right-section-width": props.rightSectionWidth !== void 0 ? require_rem.rem(props.rightSectionWidth) : void 0,
	"--input-padding-y": props.multiline ? require_get_size.getSize(props.size, "input-padding-y") : void 0,
...
const Input = require_polymorphic_factory.polymorphicFactory((_props) => {
	...
	const getStyles = require_use_styles.useStyles({
		...
		classes: require_Input_module.default,
		className,
		style,
		classNames,
		styles,
	...
	const loadingIndicator = loading ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Loader.Loader, { size: loadingPosition === "left" ? "calc(var(--input-left-section-size) / 2)" : "calc(var(--input-right-section-size) / 2)" }) : null;
	const _leftSection = loading && loadingPosition === "left" ? loadingIndicator : leftSection;
	const _rightSection = require_InputClearSection.InputClearSection({
		__clearable,
		__clearSection,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Input_context.InputContext, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(require_Box.Box, {
			...
			size,
			children: [
				_leftSection && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...leftSectionProps,
					"data-position": "left",
					...getStyles("section", {
				...
				_rightSection && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...rightSectionProps,
					"data-position": "right",
					...getStyles("section", {
...
Input.classes = require_Input_module.default;
