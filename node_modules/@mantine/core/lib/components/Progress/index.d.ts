...
export type { ProgressProps, ProgressFactory, ProgressStylesNames, ProgressLabelProps, ProgressRootProps, ProgressSectionProps, ProgressContextValue, };
export declare namespace Progress {
    type Props = ProgressProps;
    type Factory = ProgressFactory;
    type StylesNames = ProgressStylesNames;
    type ContextValue = ProgressContextValue;
    namespace Label {
    ...
    namespace Section {
        type Props = ProgressSectionProps;
    }
}
